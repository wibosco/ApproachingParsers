//
//  QuestionsRetrievalOperationGuardAndNilParser.swift
//  ApproachingParsers
//
...
class QuestionsRetrievalOperationGuardAndNilParser: NSOperation {
        ...
        do {
            ...
            ServiceManager.sharedInstance.backgroundManagedObjectContext.performBlockAndWait({ () -> Void in
                ...
                do {
                    ...
                    guard let page = parser.parseQuestions(jsonResponse) else {
